  ...
  <section id="main-registration">
    <article class="main-registration-inner">
        <form @click.prevent="" class="main-registration-form">
            ...
            <label for="">
                <input type="text" placeholder="Пароль" v-model="password" class="main-registration-input">
            </label>
            <label for="">
                <input type="text" placeholder="Повторите пароль" v-model="repeat_password" class="main-registration-input">
            </label>
            <CustomButton class="main-registration-button" @click="registration()">
                Зарегистрироваться
            </CustomButton>
        </form>
        <img src="@/assets/main/cat.svg"  class="main-registration-img">
    </article>
  </section>
</template>
